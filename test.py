import transformers 
from transformers import AutoModel,AutoImageProcessor, OpenLlamaModel, OpenLlamaConfig, AutoModelForCausalLM, AutoTokenizer
import torch
...
class VisionActionModel:
    def __init__(self,vit='dino',gpt_size='135M',env_name='waterworld'):
        ...
        self.img_projection_135M=torch.nn.Linear(1024,576)
