To run use pip install -r requirements.txt and run the test.py for vision-action model inference, test_tdmpc2.py for TDMPC2, and testDreamer.py for Dreamerv3
