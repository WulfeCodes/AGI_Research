...
from tdmpc2.tdmpc2.common import layers, math, init
...
class WorldModel(nn.Module):
	...
	def __init__(self, cfg):
		...
		#IF YOU WANT: THIS FOR MUTUALLY EXCLUSIVE INDEX MASKS
		...
		# 	indexSum = 0
		# 	for i in range(len(cfg.tasks)):
		# 		self._action_masks[i, indexSum:cfg.action_dims[i]] = 1.
		# 		indexSum+= cfg.action_dims[i]
